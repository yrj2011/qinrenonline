...
import com.qinrenzaixian.web.dao.UserDaoSupportDaoImpl;

public class TestDiskSupport extends TestCase {
    ...
    public void  testMybatis(){
    	try {
    		ApplicationContext act = new ClassPathXmlApplicationContext("/spring/applicationContext-support.xml");
    		UserDaoSupportDaoImpl blogDaoImp= (UserDaoSupportDaoImpl)act.getBean("userDaoSupportImp");
            blogDaoImp.test();
